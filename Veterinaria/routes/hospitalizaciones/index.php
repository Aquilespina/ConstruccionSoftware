...
Route::get('/reporte-diario',      [HospitalizacionesController::class, 'reporteDiario'])->name('reporte-diario');
Route::get('/reporte-diario/pdf',  [HospitalizacionesController::class, 'reporteDiarioPDF'])->name('reporte-diario-pdf');
